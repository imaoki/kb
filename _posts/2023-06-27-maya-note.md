...
#### 選択オブジェクトの種類を取得
{:#script-get-type-of-selected-object}
...
#### 選択オブジェクトの親を取得
{:#script-get-parent-of-selected-object}
...
#### 選択オブジェクトの子を取得
{:#script-get-children-of-selected-object}
...
#### 選択オブジェクトのシェイプノードを取得
{:#script-get-shape-node-of-selected-object}
...
{:#script-get-instance-node-from-shape-of-selected-object}
